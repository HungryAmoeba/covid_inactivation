...
medium.sound_speed = sphere(x_len, y_len, z_len, x_center, y_center, z_center, inner_rad, outer_rad, default_val, boundary_val, interior_val);      % [m/s]
medium.density = sphere(x_len, y_len, z_len, x_center, y_center, z_center, inner_rad, outer_rad, default_val, boundary_val, interior_val);        % [kg/m^3]
